...
def parseConfig3(tab):
	...
	for i in range(nrow):
		...
		cfg3.tap_tip_value = row[2].value
		cfgs[cfg3.key] = cfg3
	return cfgs
...
def outputXml(tab1Datas, tab2Datas, tab3Datas, tab4Datas):
	...
	for t1_data in tab1Datas:
		...
		tabTipsTabName.appendChild(withCData(u'是否空腹'))
		tabTipsNode.appendChild(tabTipsTabName)
		# -- add tap_tip_value
		tabTipsTipValue = dom.createElement('tap_tip_value')
		tabTipsTipValue.appendChild(withCData(t3_data.tap_tip_value))
		...
		tabQasQNode.appendChild(withCData(u'相关指标'))
		...
		tabQasQNode2.appendChild(withCData(u'正常值'))
		...
		# -- add tab_qas_question
		tabQasQNode2 = dom.createElement('tab_qas_question')
		tabQasQNode2.appendChild(withCData(''))
		tabQasNode2.appendChild(tabQasQNode2)
		# -- add tab_qas_answer
		tabQasANode2 = dom.createElement('tab_qas_answer')
		tabQasANode2.appendChild(withCData(''))
		tabQasNode2.appendChild(tabQasANode2)
...
def main():
	parse_xlsx("./data/20200716/Jiancha-v4-0611.xlsx")
